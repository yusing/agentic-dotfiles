...
description: Apply modern Go syntax and standard-library APIs according. Must be used for Go writing, refactoring, review, testing. Use together with `go` skill
---
